    ...
    <main className='max-w-5xl h-[640px]'>
      <div className='flex justify-between'>
        <div className='h-9 max-w-md bg-[#f5f6fa] items-center rounded-md p-3 justify-center flex gap-2'>
          <p className='text-[#667281] text-[13px] font-normal leading-3'>
            Search
          </p>
          <input 
            type="text" 
        ...
        <button onClick={handleCreatePost} type='button' className='w-40 h-9 bg-[#177EFF] text-white rounded-lg'>
          Create Post
        </button>
      </div>
      ...
      <div className="mt-6 flex max-w-lg gap-2 mb-6">
        <button
          ...
          className={`w-36 h-9 rounded-md flex p-2 justify-between items-center ${
            selectedStatus === "All" ? "bg-[#177EFF] text-white" : "bg-[#F5F6FA] hover:bg-[#177EFF] hover:text-white"
          }`}
        >
          All Status 
        ...
        <button
          ...
          className={`w-36 h-9 rounded-md flex p-2 justify-between items-center ${
            selectedStatus === "Draft" ? "bg-[#177EFF] text-white" : "bg-[#F5F6FA] hover:bg-[#177EFF] hover:text-white"
          }`}
        >
          Draft 
          <span className="h-5 flex items-center justify-center rounded-xl w-6 bg-[#B2C2DF]">
        ...
        <button
          ...
          className={`w-36 h-9 rounded-md flex p-2 justify-between items-center ${
            selectedStatus === "Published" ? "bg-[#177EFF] text-white" : "bg-[#F5F6FA] hover:bg-[#177EFF] hover:text-white"
          }`}
        >
          Published 
          <span className="h-5 flex items-center justify-center rounded-xl w-6 bg-[#B2C2DF]">
        ...
        <table className="min-w-full bg-white border border-gray-200">
          <thead>
            <tr>
              ...
              <th className="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Time</th>
